...
<body>
    ...
    <main>
        <section class="film">
            <div class="container">
                <div class="parent">
                    ...
                    <div class="details">
                        <h3>new eposides</h3>
                        <h2>Doctor Strange in  <span>the Multiverse of Madness</span></h2>
                        <div class="wrapper">
                            <div class="age">
                                pg 18
                            </div>
        ...
        <section class="preview">
                <div class="controls">
                    <button onclick="
                    document.getElementById('vid').src = 'trailer/Official Trailer  Death on the Nile  20th Century Studios.mp4';
                    ">Trailer</button>
                    <button onclick="
