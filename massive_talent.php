...
<body>
    ...
    <main>
        <section class="film">
            <div class="container">
                <div class="parent">
                    ...
                    <div class="details">
                        <h3>new eposides</h3>
                        <h2>The Unbearable  <span> Weight of Massive Talent</span></h2>
                        <div class="wrapper">
                            <div class="age">
                                pg 18
                            </div>
        ...
        <section class="preview">
                <div class="controls">
                    <button onclick="
                    document.getElementById('vid').src = 'trailer/The Unbearable Weight of Massive Talent (2022 Movie) Official Red Band Trailer – Nicolas Cage.mp4';
                    ">Trailer</button>
                    <button onclick="
